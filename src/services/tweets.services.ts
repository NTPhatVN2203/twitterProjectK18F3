  ...
  async createTweet({ user_id, body }: { user_id: string; body: TweetRequestBody }) {
    const result = await databaseService.tweets.insertOne(
      new Tweet({
        ...
        mentions: body.mentions, //dưa mình string[], mình bỏ trực tiếp vào constructor, nó sẽ convert sang ObjectId[] cho mình
        medias: body.medias,
    ...
    //result: kết quả là object có 2 thuộc tính {acknowledge: true, insertedId: 'id của tweet mới tạo }
